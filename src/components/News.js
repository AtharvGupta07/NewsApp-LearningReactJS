        ...
        <div className="row ">
          {(!this.state.loading) && this.state.articles.map((element)=>{
            ...
            <div className='container d-flex justify-content-between'>
              ...
              <button disabled={this.state.page>=Math.ceil(this.state.totalResults/this.props.pageSize)} onClick={this.handleNextClick} className='btn btn-dark'>Next &rarr;</button>
            </div>
        </div>
      </div>
